...
class AddDeviceScreen extends StatelessWidget {
  final String roomName; // <-- parámetro nuevo
  final Device? device; // null → alta, !null → edición
  const AddDeviceScreen({super.key, required this.roomName, this.device});

  @override
  Widget build(BuildContext context) {
    final name = TextEditingController(text: device?.name ?? '');
    final roomCtrl = TextEditingController(text: roomName);
